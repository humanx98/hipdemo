...
hipError_t __ww_must_check hip_import_viewport_external_semaphore(hipExternalSemaphore_t* semaphore, WwViewportExternalHandle handle);
hipError_t __ww_must_check hip_import_viewport_external_memory(hipExternalMemory_t* memory, WwViewportExternalHandle handle, usize size);