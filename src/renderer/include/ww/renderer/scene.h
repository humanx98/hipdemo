...
typedef RendererResult __ww_must_check (*scene_attach_object_instance_fn)(scene_ptr ptr, object_instance_ptr object_instance);
typedef void (*scene_destroy_fn)(scene_ptr ptr);


typedef struct scene_vtable {
    scene_set_camera_fn set_camera;
    scene_attach_object_instance_fn attach_object_instance;
